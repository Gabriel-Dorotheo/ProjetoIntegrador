...
<body class="fundo">
    ...
    <div class="container-fluid p-3 vh-100">
        ...
        <div class="row sombra rounded position-absolute top-50 start-50 translate-middle"
            style="width: 1000px; height: 500px;">


            <div class="col-6 bg-white rounded-start-3 ps-0 pe-0 d-flex align-items-center d-none d-md-block">
                <div class="container bg-white w-50 mt-5 mb-5 rounded border-rounded-3 mb-2">
                    <img src="img/pessoa-que-monitora-dados-on-line-ilustracao-desenhada-a-mao-de-um-engenheiro-de-software_203633-4852.avif"
                        alt="" class="img-fluid border-rounded-3 rounded mx-auto">
            ...
            <div class="col-md-6 fundo2 rounded-end-3">
                <div class="container bg-white w-75 mx-auto d-flex justify-content-center rounded border-rounded-3 m-5">
                    <div class="row">
                        <div class="col-12">
