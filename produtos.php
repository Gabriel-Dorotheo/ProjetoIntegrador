                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="list-group mt-5 d-flex justify-content-center">
                                <button type="button" class="btn btn-primary fw-semibold mb-3 mt-3"
                                    id="gerenciar">Gerenciar
                                    Produtos</button>
                                        ...
                                        <?php foreach ($tabela as $produto) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="actions/deletar_produto.php?id=<?= $produto['id'] ?>"><button
                                    ...
                                    <nav aria-label="navegação">
                                        <ul class="pagination justify-content-center">
                                            <?php if ($paginaAtual > 1) { ?>
                                                <li class="page-item">
                                                    <a class="page-link"
                                                        href="produtos.php?pagina=<?= $paginaAtual - 1; ?>">Anterior</a>
                                                </li>
                                            <?php } ?>
                                            <?php if ($paginaAtual == 1) { ?>
                                            ...
                                            <?php for ($i = 1; $i <= $totalPaginas; $i++) { ?>
                                                <li class="page-item <?= $paginaAtual == $i ? 'active' : 'abcde'; ?>"><a
                                                        class="page-link" href="produtos.php?pagina=<?= $i; ?>"><?= $i; ?></a>
                                                </li>
                                            <?php } ?>
                                            ...
                                            <?php if ($paginaAtual < $totalPaginas) { ?>
                                                <li class="page-item">
                                                    <a class="page-link"
                                                        href="produtos.php?pagina=<?= $paginaAtual + 1; ?>">Próxima</a>
                                                </li>
                                            <?php } ?>
                                            <?php if ($paginaAtual == $totalPaginas) { ?>
                                                <li class="page-item disabled">
                        ...
                        <div class="adicionarProduto col-10 mb-5" style="display:none;">
                            <form class="row g-3" action="actions/cadastrar_produto.php" method="POST">
                                ...
                                <div class="col-md-8 mx-auto">
                                    ...
                                    <select class="form-select" name="id_classificacao" id="id_classificacao"
                                        style="width: 200px; ">
                        ...
                        <h1 class="h1 text-center mt-5">Fornecedores</h1>
                            <form class="row g-3" action="actions/cadastrar_fornecedor.php" method="POST">
                                <div class="col-6 mx-auto mt-5">
                                    <label for="nome" class="form-label fw-bolder">Nome</label>
                                    <input type="text" class="form-control" name="nome" id="nome"
                                        placeholder="Elisa Aparecida de Jesus" required>
                                </div>
                                <div class="col-6 mx-auto mt-5">
                                    <label for="id_telefone" class="form-label fw-bolder">Telefone</label>
                                    <input type="text" class="form-control" name="id_telefone" id="id_telefone"
                                        placeholder="(012) 9 0000-0000" required>
                                </div>
                                <div class="col-6 mx-auto">
                                    ...
                                    <input type="text" class="form-control" name="razao_social" id="razao_social"
                                        placeholder="Ex: Louças Brasil LTDA" required>
                                </div>
                                <div class="col-6 mx-auto">
                        ...
                        <div class="row gx-5">
                            <?php foreach ($resultado as $f) { ?>
                                <div class="col-3 d-flex justify-content-between">
                                    <div class="card mt-5 mb-5" style="min-width: 18rem;">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                                <?= $f['razao_social'] ?>
                                            </h5>
                                            <button class="btn btn-primary mt-" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#collapseExample<?= $f['id'] ?>" aria-expanded="false"
                                                aria-controls="collapseExample<?= $f['id'] ?>">
                                                Mais informações...
                                            </button>
                                            <div class="collapse mt-3 mb-2" id="collapseExample<?= $f['id'] ?>">
                                                <div class="card card-body">
                                                    <div class="card-subtitle mb-2 text-body-secondary fw-semibold">
                                                        Nome:
                                                        <?= $f['nome'] ?>
                                                    </div>
